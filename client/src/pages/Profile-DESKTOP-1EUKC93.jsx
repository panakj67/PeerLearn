...
const StudentProfile = () => {
  ...
  function getBadge(points) {
    if (points < 100) return { name: "Rising Star", icon: "🌱" };
    if (points < 500) return { name: "Achievers Hub", icon: "🚀" };
    return { name: "Legends Club", icon: "🏆" };
  }
          ...
          <div className="flex flex-col sm:flex-row items-center shadow-lg border border-blue-100 justify-between bg-gradient-to-r from-blue-50 to-purple-100/60 rounded-3xl p-8 mb-12">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <span className="inline-block bg-yellow-100 text-yellow-800
                cursor-pointer text-md font-semibold px-4 py-1 mt-2 rounded-full shadow-sm animate-bounce">
