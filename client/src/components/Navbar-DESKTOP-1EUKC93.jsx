    ...
    <nav className="bg-white border-b border-gray-200 sticky top-0 z-2">
      <div className="max-w-7xl mx-auto py-4 flex justify-between items-center">
        ...
        <NavLink to="/" className="flex items-center gap-2">
          <img className="h-10" src="/images.png" alt="Logo" />
        ...
        <NavLink to="/bookmark">
          <img
            ...
            src="https://static.vecteezy.com/system/resources/previews/006/118/158/non_2x/illustration-of-realistic-star-shape-with-highlight-and-shadow-suitable-for-design-element-of-game-rating-and-award-achievement-3d-star-icon-free-vector.jpg"
            alt=""
          />
        </NavLink>
        {/* Login / Profile */}
